...
/**
 * TypeGetLastDocumentESchKgResponse root element
 * 
 * <p>Java class for TypeGetLastDocumentESchKgResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TypeGetLastDocumentESchKgResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "TypeGetLastDocumentESchKgResponse", propOrder = {
    "document",
    "additionalOutput"
})
public class TypeGetLastDocumentESchKgResponse
    extends TypeBaseResponse
{

    @XmlElementRef(name = "document", namespace = "http://www.crif-online.ch/webservices/crifsoapservice/v1.00", type = JAXBElement.class, required = false)
